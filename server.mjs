...
function makeServer(environmentVariables) {
    return function serverRequestor(callback, value) {
        ...
        console.log("Here is CQC_APPROOT", CQC_APPROOT)
        const server = http.createServer(function (req, res) {
          ...
          let pathname = path.join(CQC_APPROOT, sanitizePath);
            ...
            fs.exists(pathname, function (exist) {
              if (!exist) {
                ...
                return;
              } // this is synchronous whereas
                //everything else is asynchronous I believe
